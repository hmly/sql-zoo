...
-- 10. Show who won a 'Medicine' prize in an early year (before 1910, not including 1910) together 
...
SELECT winner, subject, subject IN ('Physics','Chemistry') as expr
  FROM nobel
  WHERE yr=1984
  ORDER BY expr, subject, winner;